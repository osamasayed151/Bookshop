...
public class NewestBook {
    ...
    public NewestBook(String id, int image, String bookName, String bookDes, double salary, double before, String addBasket, String favStatus) {
        this.id = id;
        this.image = image;
